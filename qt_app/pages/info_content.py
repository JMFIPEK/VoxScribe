...
INFO_TEXT = (
    ...
    "Die Transkription läuft standardmäßig über KIT ToolBox (Server); ist\n"
    "der Server nicht erreichbar, wird automatisch auf ein lokales Modell\n"
    "zurückgefallen. Aufnahme sowie Alignment/Diarization laufen immer\n"
    "lokal auf dem eigenen Rechner.\n\n"
    "Hinweis: Wird zum ersten Mal ein lokales Modell benötigt (Server\n"
    "nicht erreichbar, oder bewusst ein lokales Modell gewählt), lädt die\n"
    "App es automatisch von HuggingFace herunter (ca. 1-3 GB, je nach\n"
    "Modell). Das kann beim allerersten Mal etwas dauern — anschließend\n"
    "ist das Modell dauerhaft lokal gespeichert und wird nicht erneut\n"
    "heruntergeladen.\n\n"
    "─────────────────────────────────────────────────────────────\n"
    "  Funktionsumfang\n"
    "─────────────────────────────────────────────────────────────\n\n"
    ...
    "• GPU-Beschleunigung via CUDA oder Intel Arc GPU (falls verfügbar)\n\n\n"
    "═══════════════════════════════════════════════════════════\n"
